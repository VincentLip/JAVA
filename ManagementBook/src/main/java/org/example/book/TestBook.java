...
public class TestBook {
    ...
    public static void main() {
        ...
        Author aut = new Author(1, "Jon", "Johnson");
        Author aut2 = new Author(2, "William", "Wilson");

        Book[] livres = new Book[]{
                new Book(1, "Book_1", new Author[]{aut}, new Publisher(1, "Publisher_1"), 1990, 231, BigDecimal.valueOf(24.99), CoverType.PAPERBACK),
                new Book(2, "Book_2", new Author[]{aut, aut2}, new Publisher(2, "Publisher_2 "), 2000, 120, BigDecimal.valueOf(14.99), CoverType.PAPERBACK),
